...
package org.openhab.binding.gridpal.wireless.rest;
...
import org.openhab.binding.gridpal.wireless.internal.WirelessUtility;
...
public class WirelessResources
{
    ...
    public Response Connect(String json)
    {
        ...
        catch (FailedLoginException | IllegalArgumentException | IllegalStateException e)
        {
            ...
            response.put("exception", new JSONObject().put("name", e.getClass().getName()).put("message", e.getMessage()));
