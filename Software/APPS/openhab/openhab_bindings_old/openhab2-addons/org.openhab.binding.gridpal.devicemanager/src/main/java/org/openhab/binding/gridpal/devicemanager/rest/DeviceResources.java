...
import org.openhab.binding.gridpal.devicemanager.manager.DeviceManager;



/**
 * This class provides the interfaces to manipulate devices via REST API.
...
public class DeviceResources
{
    ...
    /** Manager instance that controls devices. */
    ...
    /**
     * Interface to retrieve all devices.
     * @return  information about all the devices on success. Otherwise, produces server error message.
     */
    @GET
    ...
    /**
     * Interface to retrieve a specific device.
     * @param   name name of the device.
     * @return  information about the device if the device is present. Otherwise, produces server error message.
     */
    @GET
    @Path("/{name: [\\w\\s&@%]+}")
    @RolesAllowed({Role.USER, Role.ADMIN})
    ...
    /**
     * Interface to update an existing device.
     * @param   params update descriptions.
     * @return  the status of the request. In case of errors, produces server error message.
     */
    @POST
    @Path("/update")
    ...
    /**
     * Interface to removes an existing device.
     * @param   name name of the device.
     * @return  the status of the request. In case of errors, produces server error message.
     */
    @GET
    ...
    /**
     * Interface to remove all existing devices.
     * @return  the status of the request. In case of errors, produces server error message.
     */
    @GET
    @Path("/remove/all")
    ...
    /**
     * Interface to export data of an item.
     * @param   item name of the item.
     * @param   fromDate start date.
     * @param   toDate end date.
     * @return  csv file containing the item data. In case of errors, produces server error message.
     */
    @GET
