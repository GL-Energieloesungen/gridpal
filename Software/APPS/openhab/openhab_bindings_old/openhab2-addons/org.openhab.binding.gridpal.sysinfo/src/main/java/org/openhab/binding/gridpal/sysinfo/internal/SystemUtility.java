...
package org.openhab.binding.gridpal.sysinfo.internal;
...
/**
 * This is a utility class that collects information from the system about resources.
...
public class SystemUtility
{
    ...
    private Pattern patternIpAddress = Pattern
            .compile("\\d+\\.\\d+\\.\\d+\\.\\d+");
...
//    }
    ...
    public JSONArray GetIPAllAddresses()
    {
        ...
        Matcher matcher = patternIpAddress.matcher(result);
