package org.openhab.binding.gridpalsysinfo.rest;
...
import org.openhab.binding.gridpalsysinfo.internal.Agent;
import org.openhab.binding.gridpalsysinfo.internal.Iftop;
import org.openhab.binding.gridpalsysinfo.internal.SystemUtility;
...
public class SystemResources {
    ...
    public Response GetInternetStatus() {
        ...
        try {
            ...
            intface.put("ip-address", utility.GetIPAddress());
    ...
    @GET
    @Path("/resources/traffic")
    @Produces(MediaType.APPLICATION_JSON)
    public Response GetTraffic() throws Exception {
        Iftop iftop = new Iftop();
        JSONObject json = iftop.getTrafficHistory("8181");
        return Response.ok(json.toString()).build();
    }
